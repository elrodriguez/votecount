...
} elseif ($_instance->childHasBeenRendered('XtRXQ54')) {
    $componentId = $_instance->getRenderedChildComponentId('XtRXQ54');
    $componentTag = $_instance->getRenderedChildComponentTagName('XtRXQ54');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XtRXQ54');
} else {
    $response = \Livewire\Livewire::mount('setting::establishment.establishment-list');
    $html = $response->html();
    $_instance->logRenderedChild('XtRXQ54', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/establishment/index.blade.php ENDPATH**/ ?>