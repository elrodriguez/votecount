...
<?php endif; ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('pharmacy_administration_symptom')); ?>"><?php echo e(__('pharmacy::labels.symptom')); ?></a></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-sad-tear"></i></i><?php echo e(__('pharmacy::labels.symptom')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.edit')); ?></sup>   
    </h1>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('pharmacy::symptom.symptom-edit', ['symptomId' => $id,'symptom_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('iz1kO33')) {
    $componentId = $_instance->getRenderedChildComponentId('iz1kO33');
    $componentTag = $_instance->getRenderedChildComponentTagName('iz1kO33');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iz1kO33');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::symptom.symptom-edit', ['symptomId' => $id,'symptom_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('iz1kO33', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
