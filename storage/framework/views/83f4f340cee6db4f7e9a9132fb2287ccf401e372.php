...
} elseif ($_instance->childHasBeenRendered('pAcbVSB')) {
    $componentId = $_instance->getRenderedChildComponentId('pAcbVSB');
    $componentTag = $_instance->getRenderedChildComponentTagName('pAcbVSB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pAcbVSB');
} else {
    $response = \Livewire\Livewire::mount('setting::modules.module-edit',['module_id'=>$id]);
    $html = $response->html();
    $_instance->logRenderedChild('pAcbVSB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/modules/edit.blade.php ENDPATH**/ ?>