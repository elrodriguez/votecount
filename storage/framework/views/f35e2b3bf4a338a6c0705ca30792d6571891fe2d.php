...
} elseif ($_instance->childHasBeenRendered('nNMwgrl')) {
    $componentId = $_instance->getRenderedChildComponentId('nNMwgrl');
    $componentTag = $_instance->getRenderedChildComponentTagName('nNMwgrl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nNMwgrl');
} else {
    $response = \Livewire\Livewire::mount('sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('nNMwgrl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('038cj4c')) {
    $componentId = $_instance->getRenderedChildComponentId('038cj4c');
    $componentTag = $_instance->getRenderedChildComponentTagName('038cj4c');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('038cj4c');
} else {
    $response = \Livewire\Livewire::mount('header-navigation');
    $html = $response->html();
    $_instance->logRenderedChild('038cj4c', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <!-- END Page Header -->
...
} elseif ($_instance->childHasBeenRendered('QmdCshd')) {
    $componentId = $_instance->getRenderedChildComponentId('QmdCshd');
    $componentTag = $_instance->getRenderedChildComponentTagName('QmdCshd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QmdCshd');
} else {
    $response = \Livewire\Livewire::mount('shortcuts');
    $html = $response->html();
    $_instance->logRenderedChild('QmdCshd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <!-- END Shortcuts -->
...
} elseif ($_instance->childHasBeenRendered('C8frGaD')) {
    $componentId = $_instance->getRenderedChildComponentId('C8frGaD');
    $componentTag = $_instance->getRenderedChildComponentTagName('C8frGaD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('C8frGaD');
} else {
    $response = \Livewire\Livewire::mount('modal-profile');
    $html = $response->html();
    $_instance->logRenderedChild('C8frGaD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <!-- END Page Wrapper -->
...
<?php /**PATH C:\laragon\www\partido\resources\views/components/app-layout.blade.php ENDPATH**/ ?>