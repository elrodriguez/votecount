<div>
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    <button wire:click="locationSearch" class="btn btn-default waves-effect waves-themed" type="button"><?php echo e(__('labels.search')); ?></button>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_ubicaciones_nuevo')): ?>
                    <a href="<?php echo e(route('inventory_location_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button"><?php echo e(__('labels.new')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <table class="table m-0">
                ...
                <tbody class="">
                    ...
                    <tr>
                        ...
                        <td class="text-center tdw-50 align-middle">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_ubicaciones_editar')): ?>
                                    <a href="<?php echo e(route('inventory_location_edit',$location->id)); ?>" class="dropdown-item">
                                        <i class="fal fa-pencil-alt mr-1"></i><?php echo e(__('labels.edit')); ?>

                                    </a>
                                    <?php endif; ?>
                                    <div class="dropdown-divider"></div>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_ubicaciones_eliminar')): ?>
                                    <button onclick="confirmDelete(<?php echo e($location->id); ?>)" type="button" class="dropdown-item text-danger">
                        ...
                        <td class="align-middle"><?php echo e($location->establishment_name); ?></td>
                        <td class="align-middle"><?php echo e($location->name); ?></td>
        ...
        <div class="card-footer pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($locations->links()); ?></div>
        </div>
    </div>
    <script type="text/javascript">
        function confirmDelete(id){
            ...
            let box = bootbox.confirm({
                ...
                {
                    if(result){
                        window.livewire.find('<?php echo e($_instance->id); ?>').deleteLocation(id)
                    }
                }
            });
...
<?php /**PATH C:\laragon\www\nuevedoce\Modules/Inventory\Resources/views/livewire/location/location-list.blade.php ENDPATH**/ ?>