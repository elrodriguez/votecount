...
} elseif ($_instance->childHasBeenRendered('l2370206398-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2370206398-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2370206398-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2370206398-0');
} else {
    $response = \Livewire\Livewire::mount('setting::modal-icon');
    $html = $response->html();
    $_instance->logRenderedChild('l2370206398-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
<?php /**PATH C:\laragon\www\partido\Modules/Setting\Resources/views/livewire/modules/module-edit.blade.php ENDPATH**/ ?>