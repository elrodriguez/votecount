<div>
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    <a href="<?php echo e(route('votecount_schools_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button">Nuevo</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <table class="table m-0">
                ...
                <tbody class="">
                    ...
                    <tr>
                        ...
                        <td class="text-center tdw-50 align-middle">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    ...
                                    <a href="<?php echo e(route('votecount_schools_edit',$school->id)); ?>" class="dropdown-item">
                        ...
                        <td class="align-middle"><?php echo e($school->province_name); ?></td>
                        <td class="align-middle"><?php echo e($school->district_name); ?></td>
                        <td class="align-middle text-right"><?php echo e($school->external_id); ?></td>
                        <td class="align-middle"><?php echo e($school->full_name); ?></td>
                        <td class="align-middle"><?php echo e($school->address); ?></td>
                        <td class="align-middle text-right"><?php echo e($school->quantity_tables); ?></td>
                        <td class="align-middle text-right"><?php echo e($school->quamtity_electors); ?></td>
                    </tr>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($schools->links()); ?></div>
        </div>
    </div>
    <script type="text/javascript">
        function confirmDelete(id){
            ...
            let box = bootbox.confirm({
                ...
                {
                    if(result){
                        window.livewire.find('<?php echo e($_instance->id); ?>').deleteSchool(id)
                    }
                }
            });
...
<?php /**PATH C:\laragon\www\partido\Modules/VoteCount\Resources/views/livewire/sachools/schools-list.blade.php ENDPATH**/ ?>