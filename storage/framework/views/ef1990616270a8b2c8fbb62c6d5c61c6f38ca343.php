...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-head-side-cough"></i></i><?php echo e(__('pharmacy::labels.diseases')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('pharmacy::labels.symptom')); ?></sup>   
    </h1>
    <div class="subheader-block">
        <?php echo e(__('pharmacy::labels.symptom')); ?>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('pharmacy::diseases.diseases-symptoms', ['diseaseId' => $id,'disease_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('NVzaX1B')) {
    $componentId = $_instance->getRenderedChildComponentId('NVzaX1B');
    $componentTag = $_instance->getRenderedChildComponentTagName('NVzaX1B');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NVzaX1B');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::diseases.diseases-symptoms', ['diseaseId' => $id,'disease_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('NVzaX1B', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
