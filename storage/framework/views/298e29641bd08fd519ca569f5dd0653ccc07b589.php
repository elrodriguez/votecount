...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::tables.tables-edit', ['tableId' => $id,'table_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('pkXqCTM')) {
    $componentId = $_instance->getRenderedChildComponentId('pkXqCTM');
    $componentTag = $_instance->getRenderedChildComponentTagName('pkXqCTM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pkXqCTM');
} else {
    $response = \Livewire\Livewire::mount('restaurant::tables.tables-edit', ['tableId' => $id,'table_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('pkXqCTM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::tables.tables-floors-modal', ['formT' => 2,'form_t' => 2])->html();
} elseif ($_instance->childHasBeenRendered('x3nSQVh')) {
    $componentId = $_instance->getRenderedChildComponentId('x3nSQVh');
    $componentTag = $_instance->getRenderedChildComponentTagName('x3nSQVh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('x3nSQVh');
} else {
    $response = \Livewire\Livewire::mount('restaurant::tables.tables-floors-modal', ['formT' => 2,'form_t' => 2]);
    $html = $response->html();
    $_instance->logRenderedChild('x3nSQVh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
