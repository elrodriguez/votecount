...
} elseif ($_instance->childHasBeenRendered('MM2JTBY')) {
    $componentId = $_instance->getRenderedChildComponentId('MM2JTBY');
    $componentTag = $_instance->getRenderedChildComponentTagName('MM2JTBY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MM2JTBY');
} else {
    $response = \Livewire\Livewire::mount('sales::document.sale-notes-list');
    $html = $response->html();
    $_instance->logRenderedChild('MM2JTBY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('3CeyAOC')) {
    $componentId = $_instance->getRenderedChildComponentId('3CeyAOC');
    $componentTag = $_instance->getRenderedChildComponentTagName('3CeyAOC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3CeyAOC');
} else {
    $response = \Livewire\Livewire::mount('sales::document.sale-notes-modal-payments');
    $html = $response->html();
    $_instance->logRenderedChild('3CeyAOC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
