...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-box-full"></i></i><?php echo e(__('pharmacy::labels.related')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.edit')); ?></sup>   
    </h1>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('pharmacy::products.related-edit', ['relatedId' => $id,'related_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('6gpDIs2')) {
    $componentId = $_instance->getRenderedChildComponentId('6gpDIs2');
    $componentTag = $_instance->getRenderedChildComponentTagName('6gpDIs2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6gpDIs2');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::products.related-edit', ['relatedId' => $id,'related_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('6gpDIs2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
