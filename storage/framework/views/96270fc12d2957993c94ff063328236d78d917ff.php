...
} elseif ($_instance->childHasBeenRendered('7hMVRyp')) {
    $componentId = $_instance->getRenderedChildComponentId('7hMVRyp');
    $componentTag = $_instance->getRenderedChildComponentTagName('7hMVRyp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7hMVRyp');
} else {
    $response = \Livewire\Livewire::mount('sales::document.sale-notes-create-form');
    $html = $response->html();
    $_instance->logRenderedChild('7hMVRyp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
