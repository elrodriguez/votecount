<div>
    <div class="card mb-g rounded-top">
            ...
            <table class="table m-0">
                <thead>
                    <tr>
                        ...
                        <th class=""><?php echo e(__('pharmacy::labels.keyword')); ?></th>
                        <th class=""><?php echo e(__('labels.description')); ?></th>
                    </tr>
                </thead>
                <tbody class="">
                    <?php if(count($relateds)>0): ?>
                        <?php $__currentLoopData = $relateds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center tdw-50 align-middle">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                        <a href="<?php echo e(route('pharmacy_administration_products_related_edit',$related->id)); ?>" class="dropdown-item">
                                            <i class="fal fa-pencil-alt mr-1"></i><?php echo e(__('labels.edit')); ?>

                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <button onclick="confirmDeleteRelated('<?php echo e($related->id); ?>')" type="button" class="dropdown-item text-danger">
                            ...
                            <td class="align-middle"><?php echo e($related->keyword); ?></td>
                            <td class="align-middle"><?php echo e($related->description); ?></td>
                        </tr>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($relateds->links()); ?></div>
        </div>
    </div>
    <script type="text/javascript">
        function confirmDeleteRelated(id){
            ...
            let box = bootbox.confirm({
                ...
                {
                    if(result){
                        window.livewire.find('<?php echo e($_instance->id); ?>').destroyRelated(id)
                    }
                }
            });
...
<?php /**PATH C:\laragon\www\nuevedoce\Modules/Pharmacy\Resources/views/livewire/products/related-list.blade.php ENDPATH**/ ?>