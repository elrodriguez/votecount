        ...
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    <a href="<?php echo e(route('inventory_brand_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button">Nuevo</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                        ...
                        <td class="text-center tdw-50 align-middle">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    ...
                                    <a href="<?php echo e(route('inventory_brand_edit',$brand->id)); ?>" class="dropdown-item">
                                        <i class="fal fa-pencil-alt mr-1"></i>Editar
                                    </a>
                                    <?php endif; ?>
                                    <div class="dropdown-divider"></div>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_marcas_eliminar')): ?>
                                    <button onclick="confirmDelete(<?php echo e($brand->id); ?>)" type="button" class="dropdown-item text-danger">
...
<?php /**PATH C:\laragon\www\nuevedoce\Modules/Inventory\Resources/views/livewire/brand/brand-list.blade.php ENDPATH**/ ?>