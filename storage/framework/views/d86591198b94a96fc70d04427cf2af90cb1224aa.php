...
} elseif ($_instance->childHasBeenRendered('S3T5tdW')) {
    $componentId = $_instance->getRenderedChildComponentId('S3T5tdW');
    $componentTag = $_instance->getRenderedChildComponentTagName('S3T5tdW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('S3T5tdW');
} else {
    $response = \Livewire\Livewire::mount('login-form');
    $html = $response->html();
    $_instance->logRenderedChild('S3T5tdW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\partido\resources\views/page_login.blade.php ENDPATH**/ ?>