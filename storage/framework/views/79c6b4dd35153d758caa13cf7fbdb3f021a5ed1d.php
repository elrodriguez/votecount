...
<?php endif; ?>
    ...
    <li class="breadcrumb-item active"><?php echo e(__('labels.edit')); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-keynote"></i></i><?php echo e(__('votecount::labels.lbl_tables')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.edit')); ?></sup>   
    </h1>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('votecount::tables.table-edit', ['tableId' => $id,'table_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('h6CMDKZ')) {
    $componentId = $_instance->getRenderedChildComponentId('h6CMDKZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('h6CMDKZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('h6CMDKZ');
} else {
    $response = \Livewire\Livewire::mount('votecount::tables.table-edit', ['tableId' => $id,'table_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('h6CMDKZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('votecount::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\partido\Modules/VoteCount\Resources/views/tables/edit.blade.php ENDPATH**/ ?>