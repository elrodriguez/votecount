...
<?php endif; ?>
    ...
    <li class="breadcrumb-item">
        <a href="<?php echo e(route('restaurant_brands_list')); ?>"><?php echo e(__('restaurant::labels.brands')); ?></a>
    </li>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::brands.brands-edit', ['brandId' => $id,'brand_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('iTYrxFE')) {
    $componentId = $_instance->getRenderedChildComponentId('iTYrxFE');
    $componentTag = $_instance->getRenderedChildComponentTagName('iTYrxFE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iTYrxFE');
} else {
    $response = \Livewire\Livewire::mount('restaurant::brands.brands-edit', ['brandId' => $id,'brand_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('iTYrxFE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
