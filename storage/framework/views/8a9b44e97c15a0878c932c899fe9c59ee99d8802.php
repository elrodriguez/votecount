...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-house"></i></i><?php echo e(__('votecount::labels.lbl_schools')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.list')); ?></sup>   
    </h1>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('votecount::sachools.schools-list', [])->html();
} elseif ($_instance->childHasBeenRendered('RDgOlbe')) {
    $componentId = $_instance->getRenderedChildComponentId('RDgOlbe');
    $componentTag = $_instance->getRenderedChildComponentTagName('RDgOlbe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RDgOlbe');
} else {
    $response = \Livewire\Livewire::mount('votecount::sachools.schools-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('RDgOlbe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('votecount::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\partido\Modules/VoteCount\Resources/views/schools/index.blade.php ENDPATH**/ ?>