...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="fal fa-shopping-cart"></i> <?php echo app('translator')->get('inventory::labels.lbl_new'); ?> <span class='fw-300'><?php echo app('translator')->get('inventory::labels.lbl_purchase'); ?></span> <sup class='badge badge-primary fw-500'><?php echo app('translator')->get('inventory::labels.btn_new'); ?></sup>
...
} elseif ($_instance->childHasBeenRendered('VzOLPw4')) {
    $componentId = $_instance->getRenderedChildComponentId('VzOLPw4');
    $componentTag = $_instance->getRenderedChildComponentTagName('VzOLPw4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VzOLPw4');
} else {
    $response = \Livewire\Livewire::mount('inventory::purchase.purchase-create');
    $html = $response->html();
    $_instance->logRenderedChild('VzOLPw4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
