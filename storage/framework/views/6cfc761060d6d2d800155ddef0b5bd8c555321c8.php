...
} elseif ($_instance->childHasBeenRendered('4IRZJlh')) {
    $componentId = $_instance->getRenderedChildComponentId('4IRZJlh');
    $componentTag = $_instance->getRenderedChildComponentTagName('4IRZJlh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4IRZJlh');
} else {
    $response = \Livewire\Livewire::mount('setting::modules.module-list');
    $html = $response->html();
    $_instance->logRenderedChild('4IRZJlh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/modules/index.blade.php ENDPATH**/ ?>