...
} elseif ($_instance->childHasBeenRendered('vKOfSIZ')) {
    $componentId = $_instance->getRenderedChildComponentId('vKOfSIZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('vKOfSIZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vKOfSIZ');
} else {
    $response = \Livewire\Livewire::mount('sales::series.series-create-form');
    $html = $response->html();
    $_instance->logRenderedChild('vKOfSIZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('sales::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Sales\Resources/views/series/create.blade.php ENDPATH**/ ?>