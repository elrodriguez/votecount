...
} elseif ($_instance->childHasBeenRendered('tQGbnM0')) {
    $componentId = $_instance->getRenderedChildComponentId('tQGbnM0');
    $componentTag = $_instance->getRenderedChildComponentTagName('tQGbnM0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tQGbnM0');
} else {
    $response = \Livewire\Livewire::mount('staff::employees.employees-search');
    $html = $response->html();
    $_instance->logRenderedChild('tQGbnM0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('staff::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\partido\Modules/Staff\Resources/views/employees/search.blade.php ENDPATH**/ ?>