    ...
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <input wire:keydown.enter="tablesearch" wire:model.defer="search" type="text" class="form-control border-left-0 bg-transparent pl-0" placeholder="Escriba aquí...">
                <div class="input-group-append">
                    <button wire:click="tablesearch" class="btn btn-default waves-effect waves-themed" type="button">Buscar</button>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configuraciones_bancos_nuevo')): ?>
                    <a href="<?php echo e(route('votecount_tables_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button">Nuevo</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <table class="table m-0">
                ...
                <tbody class="">
                    ...
                    <tr>
                        ...
                        <td class="text-center tdw-50 align-middle">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    ...
                                    <a href="<?php echo e(route('votecount_tables_edit',$table->id)); ?>" class="dropdown-item">
                                    ...
                                    <button onclick="confirmDelete(<?php echo e($table->id); ?>)" type="button" class="dropdown-item text-danger">
                        ...
                        <td class="align-middle"><?php echo e($table->full_name); ?></td>
                        <td class="align-middle"><?php echo e($table->name); ?></td>
                        <td class="align-middle text-right"><?php echo e($table->number_table); ?></td>
...
<?php /**PATH C:\laragon\www\partido\Modules/VoteCount\Resources/views/livewire/tables/table-list.blade.php ENDPATH**/ ?>