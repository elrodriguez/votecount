...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            ...
            <button onclick="updateRestaurantCategory()" wire:target="saveCategories" wire:loading.attr="disabled"
                type="button" class="btn btn-info ml-auto waves-effect waves-themed"><?php echo e(__('labels.save')); ?></button>
        </div>
    </div>
    <script type="text/javascript">
        var comboTree2 = null;
        document.addEventListener('set-category-update', event => {
...
?>;
            ...
            comboTree2 = $('#justAnotherInputBox').comboTree({
                ...
                selected: ['<?php echo e($category_id_old); ?>']
            });
        });
        ...
        function updateRestaurantCategory() {
            ...
            window.livewire.find('<?php echo e($_instance->id); ?>').updateCategory();
        }
    </script>
</div>
<?php /**PATH C:\laragon\www\nuevedoce\Modules/Restaurant\Resources/views/livewire/categories/categories-edit.blade.php ENDPATH**/ ?>