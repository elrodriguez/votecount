...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-sad-tear"></i></i><?php echo e(__('pharmacy::labels.symptom')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.new')); ?></sup>   
    </h1>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('pharmacy::symptom.symptom-create', [])->html();
} elseif ($_instance->childHasBeenRendered('a4rhXs6')) {
    $componentId = $_instance->getRenderedChildComponentId('a4rhXs6');
    $componentTag = $_instance->getRenderedChildComponentTagName('a4rhXs6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('a4rhXs6');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::symptom.symptom-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('a4rhXs6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
