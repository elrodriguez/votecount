...
} elseif ($_instance->childHasBeenRendered('SKzv1nY')) {
    $componentId = $_instance->getRenderedChildComponentId('SKzv1nY');
    $componentTag = $_instance->getRenderedChildComponentTagName('SKzv1nY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SKzv1nY');
} else {
    $response = \Livewire\Livewire::mount('inventory::item.item-edit',['item_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('SKzv1nY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('35ogVI6')) {
    $componentId = $_instance->getRenderedChildComponentId('35ogVI6');
    $componentTag = $_instance->getRenderedChildComponentTagName('35ogVI6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('35ogVI6');
} else {
    $response = \Livewire\Livewire::mount('inventory::item.item-edit-generic', ['itemId' => $id,'item_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('35ogVI6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php endif; ?>
