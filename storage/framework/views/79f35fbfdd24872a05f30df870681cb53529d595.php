...
} elseif ($_instance->childHasBeenRendered('SUjkR3q')) {
    $componentId = $_instance->getRenderedChildComponentId('SUjkR3q');
    $componentTag = $_instance->getRenderedChildComponentTagName('SUjkR3q');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SUjkR3q');
} else {
    $response = \Livewire\Livewire::mount('inventory::item.item-list');
    $html = $response->html();
    $_instance->logRenderedChild('SUjkR3q', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('15PIgqt')) {
    $componentId = $_instance->getRenderedChildComponentId('15PIgqt');
    $componentTag = $_instance->getRenderedChildComponentTagName('15PIgqt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('15PIgqt');
} else {
    $response = \Livewire\Livewire::mount('inventory::item.item-list-generic');
    $html = $response->html();
    $_instance->logRenderedChild('15PIgqt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php endif; ?>
