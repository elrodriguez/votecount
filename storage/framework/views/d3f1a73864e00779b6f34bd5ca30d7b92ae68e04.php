...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-head-side-cough"></i></i><?php echo e(__('pharmacy::labels.diseases')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.edit')); ?></sup>   
    </h1>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('pharmacy::diseases.diseases-edit', ['diseaseId' => $id,'disease_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('x1YeMWm')) {
    $componentId = $_instance->getRenderedChildComponentId('x1YeMWm');
    $componentTag = $_instance->getRenderedChildComponentTagName('x1YeMWm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('x1YeMWm');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::diseases.diseases-edit', ['diseaseId' => $id,'disease_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('x1YeMWm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
