...
} elseif ($_instance->childHasBeenRendered('ZWKUBBg')) {
    $componentId = $_instance->getRenderedChildComponentId('ZWKUBBg');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZWKUBBg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZWKUBBg');
} else {
    $response = \Livewire\Livewire::mount('setting::roles.roles-form');
    $html = $response->html();
    $_instance->logRenderedChild('ZWKUBBg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/roles/index.blade.php ENDPATH**/ ?>