...
} elseif ($_instance->childHasBeenRendered('hXSFNfD')) {
    $componentId = $_instance->getRenderedChildComponentId('hXSFNfD');
    $componentTag = $_instance->getRenderedChildComponentTagName('hXSFNfD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hXSFNfD');
} else {
    $response = \Livewire\Livewire::mount('inventory::category.category-create');
    $html = $response->html();
    $_instance->logRenderedChild('hXSFNfD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
