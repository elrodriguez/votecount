...
<?php endif; ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('inventory_location')); ?>"><?php echo e(__('inventory::labels.lbl_location')); ?></a></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-map-marker"></i></i><?php echo e(__('inventory::labels.lbl_location')); ?><sup class='badge badge-primary fw-500'>New</sup>   
    </h1>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('inventory::location.location-create')->html();
} elseif ($_instance->childHasBeenRendered('MDMuPPu')) {
    $componentId = $_instance->getRenderedChildComponentId('MDMuPPu');
    $componentTag = $_instance->getRenderedChildComponentTagName('MDMuPPu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MDMuPPu');
} else {
    $response = \Livewire\Livewire::mount('inventory::location.location-create');
    $html = $response->html();
    $_instance->logRenderedChild('MDMuPPu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Inventory\Resources/views/location/create.blade.php ENDPATH**/ ?>