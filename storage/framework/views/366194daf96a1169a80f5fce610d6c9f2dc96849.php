...
} elseif ($_instance->childHasBeenRendered('QfysDF8')) {
    $componentId = $_instance->getRenderedChildComponentId('QfysDF8');
    $componentTag = $_instance->getRenderedChildComponentTagName('QfysDF8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QfysDF8');
} else {
    $response = \Livewire\Livewire::mount('restaurant::commands.commands-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('QfysDF8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
