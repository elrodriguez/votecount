...
<?php endif; ?>
    ...
    <li class="breadcrumb-item active"><?php echo app('translator')->get('labels.notes'); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-file-invoice-dollar'></i><?php echo e(__('labels.notes')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.new')); ?></sup>
...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('sales::document.note-create', ['externalId' => $external_id,'external_id' => $external_id])->html();
} elseif ($_instance->childHasBeenRendered('MX6vLqb')) {
    $componentId = $_instance->getRenderedChildComponentId('MX6vLqb');
    $componentTag = $_instance->getRenderedChildComponentTagName('MX6vLqb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MX6vLqb');
} else {
    $response = \Livewire\Livewire::mount('sales::document.note-create', ['externalId' => $external_id,'external_id' => $external_id]);
    $html = $response->html();
    $_instance->logRenderedChild('MX6vLqb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
