...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-box-full"></i></i><?php echo e(__('pharmacy::labels.related')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.new')); ?></sup>   
    </h1>
