...
} elseif ($_instance->childHasBeenRendered('h9OnaRE')) {
    $componentId = $_instance->getRenderedChildComponentId('h9OnaRE');
    $componentTag = $_instance->getRenderedChildComponentTagName('h9OnaRE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('h9OnaRE');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::medicines.medicines-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('h9OnaRE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('pharmacy::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Pharmacy\Resources/views/medicines/index.blade.php ENDPATH**/ ?>