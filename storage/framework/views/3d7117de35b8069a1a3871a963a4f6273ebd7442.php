...
} elseif ($_instance->childHasBeenRendered('upkODOd')) {
    $componentId = $_instance->getRenderedChildComponentId('upkODOd');
    $componentTag = $_instance->getRenderedChildComponentTagName('upkODOd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('upkODOd');
} else {
    $response = \Livewire\Livewire::mount('setting::company.company-list');
    $html = $response->html();
    $_instance->logRenderedChild('upkODOd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/company/index.blade.php ENDPATH**/ ?>