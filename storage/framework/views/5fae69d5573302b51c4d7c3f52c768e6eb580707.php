<div>
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_marcas_nuevo')): ?>
                        <a href="<?php echo e(route('restaurant_brands_create')); ?>"
                ...
                <tbody class="">
                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center tdw-50 align-middle">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_marcas_editar')): ?>
                                            <a href="<?php echo e(route('restaurant_brands_edit', $brand->id)); ?>"
                                                class="dropdown-item">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurante_administracion_marcas_eliminar')): ?>
                                            <button onclick="confirmDelete(<?php echo e($brand->id); ?>)" type="button"
                            ...
                            <td class="align-middle"><?php echo e($brand->description); ?></td>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($brands->links()); ?></div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\nuevedoce\Modules/Restaurant\Resources/views/livewire/brands/brands-list.blade.php ENDPATH**/ ?>