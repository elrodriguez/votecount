...
} elseif ($_instance->childHasBeenRendered('V0lPgbe')) {
    $componentId = $_instance->getRenderedChildComponentId('V0lPgbe');
    $componentTag = $_instance->getRenderedChildComponentTagName('V0lPgbe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('V0lPgbe');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::sales.sales-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('V0lPgbe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
