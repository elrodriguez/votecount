            ...
            <form class="needs-validation <?php echo e($errors->any() ? 'was-validated' : ''); ?>" novalidate="">
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="floor"><?php echo app('translator')->get('restaurant::labels.floor'); ?>
...
<?php /**PATH C:\laragon\www\nuevedoce\Modules/Restaurant\Resources/views/livewire/tables/tables-edit.blade.php ENDPATH**/ ?>