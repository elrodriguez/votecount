...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('inventory::brand.brand-list')->html();
} elseif ($_instance->childHasBeenRendered('SJV7xvA')) {
    $componentId = $_instance->getRenderedChildComponentId('SJV7xvA');
    $componentTag = $_instance->getRenderedChildComponentTagName('SJV7xvA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SJV7xvA');
} else {
    $response = \Livewire\Livewire::mount('inventory::brand.brand-list');
    $html = $response->html();
    $_instance->logRenderedChild('SJV7xvA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Inventory\Resources/views/brand/index.blade.php ENDPATH**/ ?>