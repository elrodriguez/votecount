...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('setting::establishment.establishment-edit',['establishment_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('I3rnjx3')) {
    $componentId = $_instance->getRenderedChildComponentId('I3rnjx3');
    $componentTag = $_instance->getRenderedChildComponentTagName('I3rnjx3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('I3rnjx3');
} else {
    $response = \Livewire\Livewire::mount('setting::establishment.establishment-edit',['establishment_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('I3rnjx3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
