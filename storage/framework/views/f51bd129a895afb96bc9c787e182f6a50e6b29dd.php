...
<?php endif; ?>
    ...
    <li class="breadcrumb-item active"><?php echo e(__('setting::labels.system_environment')); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-tools'></i><?php echo e(__('setting::labels.system_environment')); ?> <sup class='badge badge-primary fw-500'><?php echo e(__('labels.edit')); ?></sup>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('setting::company.company-system-environment', ['companyId' => $id,'company_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('4u9FTAP')) {
    $componentId = $_instance->getRenderedChildComponentId('4u9FTAP');
    $componentTag = $_instance->getRenderedChildComponentTagName('4u9FTAP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4u9FTAP');
} else {
    $response = \Livewire\Livewire::mount('setting::company.company-system-environment', ['companyId' => $id,'company_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('4u9FTAP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/company/system_environment.blade.php ENDPATH**/ ?>