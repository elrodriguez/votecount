...
} elseif ($_instance->childHasBeenRendered('o5VF3eC')) {
    $componentId = $_instance->getRenderedChildComponentId('o5VF3eC');
    $componentTag = $_instance->getRenderedChildComponentTagName('o5VF3eC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('o5VF3eC');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::symptom.symptom-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('o5VF3eC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('pharmacy::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Pharmacy\Resources/views/symptom/index.blade.php ENDPATH**/ ?>