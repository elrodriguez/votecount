...
} elseif ($_instance->childHasBeenRendered('l52033418-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l52033418-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l52033418-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l52033418-0');
} else {
    $response = \Livewire\Livewire::mount('setting::modal-icon');
    $html = $response->html();
    $_instance->logRenderedChild('l52033418-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
<?php /**PATH C:\laragon\www\partido\Modules/Setting\Resources/views/livewire/modules/module-create.blade.php ENDPATH**/ ?>