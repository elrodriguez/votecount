...
<?php endif; ?>
    ...
    <li class="breadcrumb-item active"><?php echo app('translator')->get('transferservice::labels.lbl_edit'); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-store-alt'></i><?php echo app('translator')->get('transferservice::labels.lbl_locals'); ?> <sup class='badge badge-primary fw-500'><?php echo app('translator')->get('transferservice::labels.lbl_edit'); ?></sup>
        <small><?php echo app('translator')->get('transferservice::labels.lbl_available_user'); ?></small>
    </h1>
    <div class="subheader-block">
        <?php echo app('translator')->get('transferservice::labels.lbl_edit'); ?>
    </div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('transferservice::locals.locals-edit',['id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('jXrwBJX')) {
    $componentId = $_instance->getRenderedChildComponentId('jXrwBJX');
    $componentTag = $_instance->getRenderedChildComponentTagName('jXrwBJX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jXrwBJX');
} else {
    $response = \Livewire\Livewire::mount('transferservice::locals.locals-edit',['id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('jXrwBJX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
