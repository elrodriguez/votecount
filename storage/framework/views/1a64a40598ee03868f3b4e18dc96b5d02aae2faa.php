...
<?php endif; ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('sales_expenses_list')); ?>"><?php echo app('translator')->get('sales::labels.expenses'); ?></a></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-cash-register'></i><?php echo e(__('sales::labels.expenses')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.new')); ?></sup>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('sales::expenses.expenses-edit', ['expenseId' => $id,'expense_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('KtUNYwN')) {
    $componentId = $_instance->getRenderedChildComponentId('KtUNYwN');
    $componentTag = $_instance->getRenderedChildComponentTagName('KtUNYwN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KtUNYwN');
} else {
    $response = \Livewire\Livewire::mount('sales::expenses.expenses-edit', ['expenseId' => $id,'expense_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('KtUNYwN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('sales::expenses.expenses-supplier-modal', [])->html();
} elseif ($_instance->childHasBeenRendered('DRfRfrE')) {
    $componentId = $_instance->getRenderedChildComponentId('DRfRfrE');
    $componentTag = $_instance->getRenderedChildComponentTagName('DRfRfrE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DRfRfrE');
} else {
    $response = \Livewire\Livewire::mount('sales::expenses.expenses-supplier-modal', []);
    $html = $response->html();
    $_instance->logRenderedChild('DRfRfrE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
