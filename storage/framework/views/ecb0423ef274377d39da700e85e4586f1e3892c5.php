...
} elseif ($_instance->childHasBeenRendered('eA8uDLZ')) {
    $componentId = $_instance->getRenderedChildComponentId('eA8uDLZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('eA8uDLZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eA8uDLZ');
} else {
    $response = \Livewire\Livewire::mount('restaurant::tables.tables-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('eA8uDLZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('restaurant::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Restaurant\Resources/views/tables/index.blade.php ENDPATH**/ ?>