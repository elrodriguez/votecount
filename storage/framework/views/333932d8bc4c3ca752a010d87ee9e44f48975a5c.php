...
} elseif ($_instance->childHasBeenRendered('TvDg7mk')) {
    $componentId = $_instance->getRenderedChildComponentId('TvDg7mk');
    $componentTag = $_instance->getRenderedChildComponentTagName('TvDg7mk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TvDg7mk');
} else {
    $response = \Livewire\Livewire::mount('setting::company.company-edit',['company_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('TvDg7mk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\partido\Modules/Setting\Resources/views/company/edit.blade.php ENDPATH**/ ?>