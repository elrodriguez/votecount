...
} elseif ($_instance->childHasBeenRendered('ByY2ukt')) {
    $componentId = $_instance->getRenderedChildComponentId('ByY2ukt');
    $componentTag = $_instance->getRenderedChildComponentTagName('ByY2ukt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ByY2ukt');
} else {
    $response = \Livewire\Livewire::mount('setting::modules.module-create');
    $html = $response->html();
    $_instance->logRenderedChild('ByY2ukt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/modules/create.blade.php ENDPATH**/ ?>