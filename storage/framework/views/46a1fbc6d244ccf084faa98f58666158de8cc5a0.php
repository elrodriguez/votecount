<div>
    <div class="modal" tabindex="-1" id="create-parameters" wire:ignore.self >
        <form class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo app('translator')->get('labels.new'); ?> <?php echo app('translator')->get('labels.parameter'); ?></h5>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model.defer="id_parameter" class="form-control" id="parameter">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:loading.attr="disabled" wire:click="store()"><?php echo app('translator')->get('labels.save'); ?></button>
                </div>
            </div>
        </form>
    </div>
    <script defer>
        window.addEventListener('message-confir-modal-paramter', event => {
        ...
        window.addEventListener('open-modal-paramter', event => {
            $('#create-parameters').modal('show');
        });
    </script>
</div>
<?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/livewire/parameters/parameters-create.blade.php ENDPATH**/ ?>