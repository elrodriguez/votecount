                        ...
                        <?php $__currentLoopData = $payment_method_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $payment_method_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-row">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <?php $__errorArgs = ['payment_method_types.'.$key.'.date_of_payment'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-3 mb-3" wire:ignore.self>
                                    ...
                                    <?php $__errorArgs = ['payment_method_types.'.$key.'.method'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-2 mb-3" wire:ignore.self>
                                    ...
                                    <?php $__errorArgs = ['payment_method_types.'.$key.'.destination'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <?php $__errorArgs = ['payment_method_types.'.$key.'.reference'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            ...
            <button type="button" class="btn btn-primary ml-auto waves-effect waves-themed" wire:loading.attr="disabled" wire:click="update">
                ...
                <span><?php echo e(__('labels.to_update')); ?></span>
            </button>
        </div>
    </div>
    <!-- Modal -->
...
unset($__errorArgs, $__bag); ?>
    ...
    <script type="text/javascript" defer>
        document.addEventListener('livewire:load', function () {
            ...
            $('.companiesAutoComplete').autoComplete(
                'set', { value: "<?php echo e($supplier_value); ?>", text: "<?php echo e($supplier_text); ?>" }
            ).on('autocomplete.select', function (evt, item) {
                window.livewire.find('<?php echo e($_instance->id); ?>').set('supplier_id',item.value);
            });
        });
        document.addEventListener('response_expenses_update', event => {
...
<?php /**PATH C:\laragon\www\nuevedoce\Modules/Sales\Resources/views/livewire/expenses/expenses-edit.blade.php ENDPATH**/ ?>