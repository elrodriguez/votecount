...
<?php endif; ?>
    <li class="breadcrumb-item"><?php echo e(__('inventory::labels.lbl_inventory')); ?></li>
    <li class="breadcrumb-item active"><?php echo e(__('inventory::labels.lbl_location')); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-map-marker"></i></i><?php echo e(__('inventory::labels.lbl_location')); ?><sup class='badge badge-primary fw-500'>List</sup>   
    </h1>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('inventory::location.location-list')->html();
} elseif ($_instance->childHasBeenRendered('BVgbTHf')) {
    $componentId = $_instance->getRenderedChildComponentId('BVgbTHf');
    $componentTag = $_instance->getRenderedChildComponentTagName('BVgbTHf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BVgbTHf');
} else {
    $response = \Livewire\Livewire::mount('inventory::location.location-list');
    $html = $response->html();
    $_instance->logRenderedChild('BVgbTHf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Inventory\Resources/views/location/index.blade.php ENDPATH**/ ?>