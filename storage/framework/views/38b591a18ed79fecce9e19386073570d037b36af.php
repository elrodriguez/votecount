...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::brands.brands-create', [])->html();
} elseif ($_instance->childHasBeenRendered('mZwHbLy')) {
    $componentId = $_instance->getRenderedChildComponentId('mZwHbLy');
    $componentTag = $_instance->getRenderedChildComponentTagName('mZwHbLy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mZwHbLy');
} else {
    $response = \Livewire\Livewire::mount('restaurant::brands.brands-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('mZwHbLy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
