...
<?php $__env->startSection('content'); ?>
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('restaurant::categories.categories-edit', ['categoryId' => $id,'category_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('UHRkHCc')) {
    $componentId = $_instance->getRenderedChildComponentId('UHRkHCc');
    $componentTag = $_instance->getRenderedChildComponentTagName('UHRkHCc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UHRkHCc');
} else {
    $response = \Livewire\Livewire::mount('restaurant::categories.categories-edit', ['categoryId' => $id,'category_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('UHRkHCc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
