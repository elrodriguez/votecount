...
} elseif ($_instance->childHasBeenRendered('sPGo9AF')) {
    $componentId = $_instance->getRenderedChildComponentId('sPGo9AF');
    $componentTag = $_instance->getRenderedChildComponentTagName('sPGo9AF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sPGo9AF');
} else {
    $response = \Livewire\Livewire::mount('restaurant::commands.commands-edit', ['commandId' => $id,'command_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('sPGo9AF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
