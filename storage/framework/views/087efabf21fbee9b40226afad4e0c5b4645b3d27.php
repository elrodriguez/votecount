...
} elseif ($_instance->childHasBeenRendered('Ar6pH1u')) {
    $componentId = $_instance->getRenderedChildComponentId('Ar6pH1u');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ar6pH1u');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ar6pH1u');
} else {
    $response = \Livewire\Livewire::mount('setting::modules.module-permissions',['module_id'=>$id]);
    $html = $response->html();
    $_instance->logRenderedChild('Ar6pH1u', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/modules/permissions.blade.php ENDPATH**/ ?>