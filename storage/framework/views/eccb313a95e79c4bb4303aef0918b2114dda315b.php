...
} elseif ($_instance->childHasBeenRendered('V87ClwX')) {
    $componentId = $_instance->getRenderedChildComponentId('V87ClwX');
    $componentTag = $_instance->getRenderedChildComponentTagName('V87ClwX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('V87ClwX');
} else {
    $response = \Livewire\Livewire::mount('setting::company.company-list');
    $html = $response->html();
    $_instance->logRenderedChild('V87ClwX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\partido\Modules/Setting\Resources/views/company/index.blade.php ENDPATH**/ ?>