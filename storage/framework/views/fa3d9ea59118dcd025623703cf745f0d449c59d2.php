    ...
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <input wire:keydown.enter="bankSearch" wire:model.defer="search" type="text" class="form-control border-left-0 bg-transparent pl-0" placeholder="Escriba aquí...">
                <div class="input-group-append">
                    <button wire:click="bankSearch" class="btn btn-default waves-effect waves-themed" type="button">Buscar</button>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configuraciones_bancos_nuevo')): ?>
                    <a href="<?php echo e(route('setting_banks_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button">Nuevo</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <table class="table m-0">
                ...
                <tbody class="">
                    ...
                    <tr>
                        ...
                        <td class="text-center tdw-50 align-middle">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configuraciones_bancos_editar')): ?>
                                    <a href="<?php echo e(route('setting_banks_edit',$bank->id)); ?>" class="dropdown-item">
                                        <i class="fal fa-pencil-alt mr-1"></i><?php echo e(__('labels.edit')); ?>

                                    </a>
                                    <?php endif; ?>
                                    <div class="dropdown-divider"></div>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configuraciones_bancos_eliminar')): ?>
                                    <button onclick="confirmDelete(<?php echo e($bank->id); ?>)" type="button" class="dropdown-item text-danger">
                        ...
                        <td class="align-middle"><?php echo e($bank->description); ?></td>
                    </tr>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto"><?php echo e($banks->links()); ?></div>
        </div>
    </div>
    <script type="text/javascript">
        function confirmDelete(id){
            ...
            let box = bootbox.confirm({
                ...
                {
                    if(result){
                        window.livewire.find('<?php echo e($_instance->id); ?>').deletebank(id)
                    }
                }
            });
...
<?php /**PATH C:\laragon\www\partido\Modules/Setting\Resources/views/livewire/banks/banks-list.blade.php ENDPATH**/ ?>