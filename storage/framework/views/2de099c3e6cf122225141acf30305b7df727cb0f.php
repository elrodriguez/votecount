...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-hashtag"></i></i><?php echo e(__('sales::labels.series')); ?><sup class='badge badge-primary fw-500'><?php echo e(__('labels.edit')); ?></sup>   
    </h1>
...
<?php $__env->startSection('content'); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('sales::series.series-edit-form',['serie_id' => $id])->html();
} elseif ($_instance->childHasBeenRendered('K1Z2qgV')) {
    $componentId = $_instance->getRenderedChildComponentId('K1Z2qgV');
    $componentTag = $_instance->getRenderedChildComponentTagName('K1Z2qgV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('K1Z2qgV');
} else {
    $response = \Livewire\Livewire::mount('sales::series.series-edit-form',['serie_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('K1Z2qgV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('sales::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Sales\Resources/views/series/edit.blade.php ENDPATH**/ ?>