...
} elseif ($_instance->childHasBeenRendered('U34P0In')) {
    $componentId = $_instance->getRenderedChildComponentId('U34P0In');
    $componentTag = $_instance->getRenderedChildComponentTagName('U34P0In');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('U34P0In');
} else {
    $response = \Livewire\Livewire::mount('setting::roles.roles-form');
    $html = $response->html();
    $_instance->logRenderedChild('U34P0In', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\partido\Modules/Setting\Resources/views/roles/index.blade.php ENDPATH**/ ?>