...
} elseif ($_instance->childHasBeenRendered('mtQ196p')) {
    $componentId = $_instance->getRenderedChildComponentId('mtQ196p');
    $componentTag = $_instance->getRenderedChildComponentTagName('mtQ196p');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mtQ196p');
} else {
    $response = \Livewire\Livewire::mount('inventory::category.category-list');
    $html = $response->html();
    $_instance->logRenderedChild('mtQ196p', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('inventory::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Inventory\Resources/views/category/index.blade.php ENDPATH**/ ?>