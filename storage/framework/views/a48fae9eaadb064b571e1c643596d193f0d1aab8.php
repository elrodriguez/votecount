...
} elseif ($_instance->childHasBeenRendered('bS1thHo')) {
    $componentId = $_instance->getRenderedChildComponentId('bS1thHo');
    $componentTag = $_instance->getRenderedChildComponentTagName('bS1thHo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bS1thHo');
} else {
    $response = \Livewire\Livewire::mount('setting::roles.roles-permissions',['role_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('bS1thHo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
