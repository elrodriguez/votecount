        ...
        <div class="card-body">
            <div class="form-row" wire:ignore.self>
                <div class="col-md-4 mb-3">
                    ...
                    <input data-url="<?php echo e(route('pharmacy_products_search')); ?>" class="form-control basicAutoComplete"  type="text" placeholder="Buscar producto" autocomplete="off" />
                        ...
                        <ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
                            <?php $__currentLoopData = $xitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $xitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item d-flex flex-row align-items-center">
                                    <div class="text-short-er" data-toggle="tooltip" data-placement="auto" data-original-title="<?php echo e($xitem->name); ?>"><?php echo e($xitem->name); ?></div>
                                    <button wire:click="addItemRelated(<?php echo e($xitem->id); ?>,'<?php echo e($xitem->name); ?>')" type="button" class="btn btn-dark btn-sm ml-auto btn-icon rounded-circle waves-effect waves-themed">
...
<?php /**PATH C:\laragon\www\nuevedoce\Modules/Pharmacy\Resources/views/livewire/products/related-create.blade.php ENDPATH**/ ?>