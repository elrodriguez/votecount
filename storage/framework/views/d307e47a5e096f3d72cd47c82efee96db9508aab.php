...
} elseif ($_instance->childHasBeenRendered('HwXTrLo')) {
    $componentId = $_instance->getRenderedChildComponentId('HwXTrLo');
    $componentTag = $_instance->getRenderedChildComponentTagName('HwXTrLo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HwXTrLo');
} else {
    $response = \Livewire\Livewire::mount('sales::document.document-create-form');
    $html = $response->html();
    $_instance->logRenderedChild('HwXTrLo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
