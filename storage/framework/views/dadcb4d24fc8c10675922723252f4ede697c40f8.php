...
} elseif ($_instance->childHasBeenRendered('jHPfyRP')) {
    $componentId = $_instance->getRenderedChildComponentId('jHPfyRP');
    $componentTag = $_instance->getRenderedChildComponentTagName('jHPfyRP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jHPfyRP');
} else {
    $response = \Livewire\Livewire::mount('pharmacy::medicines.medicines-create', []);
    $html = $response->html();
    $_instance->logRenderedChild('jHPfyRP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
