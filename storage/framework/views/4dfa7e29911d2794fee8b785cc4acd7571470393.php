...
} elseif ($_instance->childHasBeenRendered('RlhfVUF')) {
    $componentId = $_instance->getRenderedChildComponentId('RlhfVUF');
    $componentTag = $_instance->getRenderedChildComponentTagName('RlhfVUF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RlhfVUF');
} else {
    $response = \Livewire\Livewire::mount('setting::company.company-edit',['company_id' => $id]);
    $html = $response->html();
    $_instance->logRenderedChild('RlhfVUF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/company/edit.blade.php ENDPATH**/ ?>