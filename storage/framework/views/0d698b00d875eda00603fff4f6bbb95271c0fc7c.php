...
} elseif ($_instance->childHasBeenRendered('A9b2mHJ')) {
    $componentId = $_instance->getRenderedChildComponentId('A9b2mHJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('A9b2mHJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('A9b2mHJ');
} else {
    $response = \Livewire\Livewire::mount('setting::banks.banks-accounts-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('A9b2mHJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('setting::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\nuevedoce\Modules/Setting\Resources/views/banks/accounts.blade.php ENDPATH**/ ?>