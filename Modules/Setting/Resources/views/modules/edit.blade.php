...
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-cubes'></i>{{ __('setting::labels.modules') }} </span> <sup class='badge badge-primary fw-500'>Edit</sup>
    </h1>
...
@endsection
@section('content')
    @livewire('setting::modules.module-edit',['module_id'=>$id])
@endsection
