...
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-cubes'></i>{{ __('setting::labels.modules') }} </span> <sup class='badge badge-primary fw-500'>New</sup>
    </h1>
...
@endsection
@section('content')
    @livewire('setting::modules.module-create')
@endsection
