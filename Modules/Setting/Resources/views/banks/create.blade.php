...
@section('subheader')
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-pig"></i></i>{{ __('labels.bank_entities') }}<sup class='badge badge-primary fw-500'>{{ __('labels.new') }}</sup>   
    </h1>
...
@endsection
@section('content')
@livewire('setting::banks.banks-create')
@endsection
