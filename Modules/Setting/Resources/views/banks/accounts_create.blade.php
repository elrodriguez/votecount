...
@section('subheader')
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-piggy-bank"></i></i>{{ __('labels.bank_accounts') }}<sup class='badge badge-primary fw-500'>{{ __('labels.new') }}</sup>   
    </h1>
...
@endsection
@section('content')
    <livewire:setting::banks.banks-accounts-create />
@endsection
