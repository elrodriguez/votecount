...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('setting_banks_accounts') }}">{{ __('labels.bank_accounts') }}</a></li>
    <li class="breadcrumb-item">{{ __('labels.edit') }}</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><x-js-get-date></x-js-get-date></li>
@endsection
@section('subheader')
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-piggy-bank"></i></i>{{ __('labels.bank_accounts') }}<sup class='badge badge-primary fw-500'>{{ __('labels.edit') }}</sup>   
    </h1>
...
@endsection
@section('content')
    <livewire:setting::banks.banks-accounts-edit :account_id="$id" />
@endsection
