        ...
        <form class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('labels.new') @lang('labels.parameter')</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:loading.attr="disabled" wire:click="store()">@lang('labels.save')</button>
                </div>
            </div>
        </form>
    </div>
