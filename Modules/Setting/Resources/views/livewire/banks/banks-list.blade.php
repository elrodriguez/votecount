<div>
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    <a href="{{ route('setting_banks_create') }}" class="btn btn-success waves-effect waves-themed" type="button">Nuevo</a>
                    @endcan
                </div>
            </div>
        </div>
            ...
            <table class="table m-0">
                ...
                <tbody class="">
                    ...
                    <tr>
                        ...
                        <td class="text-center tdw-50 align-middle">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    @can('configuraciones_bancos_editar')
                                    <a href="{{ route('setting_banks_edit',$bank->id) }}" class="dropdown-item">
                                        <i class="fal fa-pencil-alt mr-1"></i>{{ __('labels.edit') }}
                                    </a>
                                    @endcan
                                    <div class="dropdown-divider"></div>
                                    @can('configuraciones_bancos_eliminar')
                                    <button onclick="confirmDelete({{ $bank->id }})" type="button" class="dropdown-item text-danger">
                        ...
                        <td class="align-middle">{{ $bank->description }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div class="card-footer  pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto">{{ $banks->links() }}</div>
        </div>
    </div>
