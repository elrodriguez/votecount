...
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i>@lang('staff::labels.lbl_employees') <sup class='badge badge-primary fw-500'>@lang('staff::labels.lbl_edit')</sup>
...
@endsection
@section('content')
    @livewire('staff::employees.employees-edit',['id' => $id])
@endsection
@section('script')
