<div>
    <div class="card mb-g rounded-top">
        <div class="card-body">
            <form class="needs-validation {{ $errors->any()?'was-validated':'' }}" novalidate="">
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="description">@lang('staff::labels.lbl_description') </label>
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            <a href="{{ route('staff_occupation_index')}}" type="button" class="btn btn-secondary waves-effect waves-themed">@lang('staff::labels.lbl_list')</a>
