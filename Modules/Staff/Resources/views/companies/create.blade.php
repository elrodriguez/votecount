...
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-landmark'></i>{{ __('staff::labels.lbl_companies') }} <sup class='badge badge-primary fw-500'>@lang('staff::labels.lbl_new')</sup>
...
@endsection
@section('content')
    @livewire('staff::companies.companies-search')
    @livewire('staff::companies.companies-create', ['id' => $id])
@endsection
@section('script')
