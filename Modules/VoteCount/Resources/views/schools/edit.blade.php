...
@section('subheader')
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-house"></i></i>{{ __('votecount::labels.lbl_schools') }}<sup class='badge badge-primary fw-500'>{{ __('labels.edit') }}</sup>   
    </h1>
...
@endsection
@section('content')
<livewire:votecount::sachools.schools-edit :school_id="$id" />
@endsection