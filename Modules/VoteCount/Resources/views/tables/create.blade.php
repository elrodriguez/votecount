...
@section('subheader')
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-keynote"></i></i>{{ __('votecount::labels.lbl_tables') }}<sup class='badge badge-primary fw-500'>{{ __('labels.new') }}</sup>   
    </h1>
...
@endsection
@section('content')
<livewire:votecount::tables.table-create />
@endsection
@section('script')
